        ...
        <div data-role="page">
            ...
            <div data-role="panel" id="menuDerecha" data-position="right" data-theme="b" data-display="reveal" data-dismissible="true">
                <ul data-role="listview" data-inset="true">
                    ...
                    <li id="cerrarSesion">
                        <a href="#" data-transition="slidedown" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-icon-power ui-btn-icon-right ui-btn-b" onclick="javascript:cerrarSesion();">Cerrar sesión</a>
                    </li>
                </ul>
            </div>
