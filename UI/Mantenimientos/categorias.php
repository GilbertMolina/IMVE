    ...
    <body onload="CategoriasOnLoad()">
        <div data-role="page">
            ...
            <div data-role="content">
                <div class="container">
                    <h3 class="text-center">Listado de Categorías de Personas</h3>
                    <hr>
                    <fieldset data-role="controlgroup" data-type="horizontal" data-mini="true" class="text-right" onchange="CategoriasCargarCategoriasListado()">
                        <input type="radio" name="estadoCategoria" id="activas" value="A" checked="checked">
                        <label for="activas">Activas</label>
                        <input type="radio" name="estadoCategoria" id="inactivas" value="I">
            ...
            <div data-role="footer" data-theme="b" data-position="fixed">
                <div data-role="navbar">
                    <ul>
                        <li><a href="#" data-transition="flip" data-icon="plus" data-theme="b" onclick="UtiMantenimientosPaginaMantenimientosCategoriasPersonasDetalleAgregar()">Agregar</a></li>
                    </ul>
                </div>
            </div>
        </div>
