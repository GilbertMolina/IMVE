...
<html>
    ...
    <body onload="UsuariosDetalleOnLoad()">
        <div data-role="page">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
                            ...
                            <form method="post" action="#" id="usuariosDetalle">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-10">
                                        <button type="button" id="btnAceptar" data-theme="b" onclick="UsuariosRegistrarUsuario()" class="ui-btn ui-shadow ui-corner-all ui-btn-b ui-btn-icon-left ui-icon-plus">Crear</button>
                                    </div>
                                    <div class="col-xs-1"></div>
                                </div>
                            </form>
            ...
            <div data-role="footer" data-theme="b" data-position="fixed">
                <div data-role="navbar">
                    <ul>
                        <li><a href="#" data-transition="flip" data-icon="carat-l" data-theme="b" onclick="UtiMantenimientosPaginaMantenimientosUsuarios()">Atrás</a></li>
                    </ul>
                </div>
            </div>
        </div>
