        ...
        <div data-role="page">
            ...
            <div data-role="content">
                <div class="container">
                    ...
                    <hr>
                    <fieldset data-role="controlgroup" data-type="horizontal" data-mini="true" class="text-right" onchange="UsuariosCargarPersonasListado()">
                        <input type="radio" name="estadoUsuario" id="activas" value="A" checked="checked">
                        <label for="activas">Activos</label>
                        <input type="radio" name="estadoUsuario" id="inactivas" value="I">
