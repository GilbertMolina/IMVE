...
<html>
    <head>
        ...
        <script src="../../Negocio/Mantenimientos/categoriasGruposCN.js" type="text/javascript"></script>
        <script src="../Includes/js/utilitarios.js" type="text/javascript"></script>
        <!-- Fin carga de los archivos javascript -->
    </head>
    <body onload="CategoriasGruposOnLoad()">
        <div data-role="page">
            ...
            <div data-role="content">
                <div class="container">
                    <h3 class="text-center">Listado de Categorías de Grupos</h3>
                    <hr>
                    <fieldset data-role="controlgroup" data-type="horizontal" data-mini="true" class="text-right" onchange="CategoriasGruposCargarCategoriasGruposListado()">
                        <input type="radio" name="estadoCategoriaGrupo" id="activas" value="A" checked="checked">
                        <label for="activas">Activas</label>
                        <input type="radio" name="estadoCategoriaGrupo" id="inactivas" value="I">
                        <label for="inactivas">Inactivas</label>
                    </fieldset>
                    <form class="ui-filterable">
                        <input id="filtro" data-type="search" placeholder="Búsqueda">
                    </form>
                    <ul data-role="listview" id="listaCategoriasGrupos" data-filter="true" data-input="#filtro" data-autodividers="true" data-inset="true">
            ...
            <div data-role="footer" data-theme="b" data-position="fixed">
                <div data-role="navbar">
                    <ul>
                        <li><a href="#" data-transition="flip" data-icon="plus" data-theme="b" onclick="UtiMantenimientosPaginaMantenimientosCategoriasGruposDetalleAgregar()">Agregar</a></li>
                    </ul>
                </div>
            </div>
        </div>
