...
<html>
    ...
    <body onload="CategoriasGruposDetalleOnLoad()">
        <div data-role="page">
            ...
            <div data-role="footer" data-theme="b" data-position="fixed">
                <div data-role="navbar">
                    <ul>
                        <li><a href="#" data-transition="flip" data-icon="carat-l" data-theme="b" onclick="UtiMantenimientosPaginaMantenimientosCategoriasGrupos()">Atrás</a></li>
                    </ul>
                </div>
            </div>
        </div>
