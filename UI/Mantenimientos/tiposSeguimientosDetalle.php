...
<html>
    <head>
        ...
        <script src="../../Negocio/Mantenimientos/tiposSeguimientosCN.js" type="text/javascript"></script>
        <script src="../Includes/js/utilitarios.js" type="text/javascript"></script>
        <!-- Fin carga de los archivos javascript -->
    </head>
    <body onload="TiposSeguimientosDetalleOnLoad()">
        <div data-role="page">
            ...
            <div data-role="panel" id="menuDerecha" data-position="right" data-theme="b" data-display="reveal" data-dismissible="true">
                <div data-role="collapsible" data-theme="a">
                    ...
                    <ul data-role="listview">
                        <li>
                            <a href="#" style="font-size: 15px" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-icon-edit ui-btn-icon-right ui-btn-b" onclick="UtiMantenimientosPaginaCambiarContrasena()">Cambiar mi contraseña</a>
                        </li>
                        <li>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
                            <h3 class="text-center">Mantenimiento de Tipos de Seguimientos</h3>
                            <hr>
                            <form method="post" action="#" id="tiposSeguimientosDetalle">
                                <div>
                                    <label for="txtDescripcionTipoSeguimiento">Descripción:<img src="../Includes/images/warning.ico" alt="Necesario" height="24px" width="24px" align="right"></label>
                                    <input type="text" name="txtDescripcionTipoSeguimiento" id="txtDescripcionTipoSeguimiento" maxlength="50" data-clear-btn="true"/>
                                </div>
                                <br>
                                <div>
                                    <label for="cboEstadoTipoSeguimiento">Estado:</label>
                                    <select name="cboEstadoTipoSeguimiento" id="cboEstadoTipoSeguimiento" disabled>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-10">
                                        <button type="button" id="btnAceptar" data-theme="b" onclick="TiposSeguimientosRegistrarTipoSeguimiento()" class="ui-btn ui-shadow ui-corner-all ui-btn-b ui-btn-icon-left ui-icon-plus">Agregar</button>
                                    </div>
                                    <div class="col-xs-1"></div>
                                </div>
                            </form>
            ...
            <div data-role="footer" data-theme="b" data-position="fixed">
                <div data-role="navbar">
                    <ul>
                        <li><a href="#" data-transition="flip" data-icon="carat-l" data-theme="b" onclick="UtiMantenimientosPaginaMantenimientosTiposSeguimientos()">Atrás</a></li>
                    </ul>
                </div>
            </div>
        </div>
