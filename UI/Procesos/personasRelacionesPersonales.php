...
<html>
    <head>
        ...
        <script src="../../Negocio/Procesos/personasRelacionesPersonalesCN.js" type="text/javascript"></script>
        <script src="../Includes/js/utilitarios.js" type="text/javascript"></script>
        <!-- Fin carga de los archivos javascript -->
    </head>
    <body onload="PersonasRelacionesPersonalesOnLoad()">
        <div data-role="page">
            ...
            <div data-role="content">
                <div class="container">
                    <h3 class="text-center">Relaciones familiares de <?php echo $utilitarios->ObtenerNombrePersona() ?></h3>
                    <hr>
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6">
                            <form method="post" action="#" id="categoriasDetalle">
                                <div>
                                    <label for="cboIdTipoRelacion">Tipo de relación:<img src="../Includes/images/warning.ico" alt="Necesario" height="24px" width="24px" align="right"></label>
                                    <select name="cboIdTipoRelacion" id="cboIdTipoRelacion">
                                ...
                                <br>
                                <div>
                                    <label for="cboIdPersona">Persona a relacionar:<img src="../Includes/images/warning.ico" alt="Necesario" height="24px" width="24px" align="right"></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-10">
                                        <button type="button" id="btnAceptar" data-theme="b" onclick="PersonasRelacionesPersonalesRegistrarRelacion()" class="ui-btn ui-shadow ui-corner-all ui-btn-b ui-btn-icon-left ui-icon-plus">Agregar</button>
                                    </div>
                                    <div class="col-xs-1"></div>
                                </div>
                            </form>
                    ...
                    <div id="divListaRelacionesPersonales">
                        <!-- Aquí se insertan los datos dinámicamente -->
                    </div>
                </div>
            </div>
            <div data-role="footer" data-theme="b" data-position="fixed">
                <div data-role="navbar">
                    <div>
                        <ul>
                            <li><a href="#" data-transition="flip" data-icon="carat-l" data-theme="b" onclick="UtiProcesosPaginaProcesosPersonasDetalleModificar(ObtenerParametroPorNombre('IdPersona'))">Volver a la Persona</a></li>
                            <li><a href="#" data-transition="flip" data-icon="carat-r" data-theme="b" onclick="UtiProcesosPaginaProcesosPersonas()">Volver a la Agenda</a></li></ul>
                    </div>
                </div>
            </div>
        </div>
