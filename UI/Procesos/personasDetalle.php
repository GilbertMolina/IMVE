        ...
        <div data-role="page">
            ...
            <div data-role="footer" data-theme="b" data-position="fixed">
                <div data-role="navbar">
                    <div id="NuevaPersona" style="display: none">
                        <ul>
                            <li><a href="#" data-transition="flip" data-icon="carat-l" data-theme="b" onclick="UtiProcesosPaginaProcesosPersonas()">Atrás</a></li>
                        </ul>
                    </div>
                    <div id="DetallePersona" style="display: none">
                        <ul>
                            <li><a href="#" data-transition="flip" data-icon="carat-l" data-theme="b" onclick="UtiProcesosPaginaProcesosPersonas()">Atrás</a></li>
                            <li><button href="#" class="ui-btn ui-shadow ui-corner-all ui-btn-icon-top ui-icon-plus" data-theme="b" onclick="UtiProcesosPaginaProcesosPersonasRelacionesPersonales(ObtenerParametroPorNombre('IdPersona'))">Relaciones familiares</button></li>
                        </ul>
                    </div>
                    <div id="DesdeVisita" style="display: none">
                        <ul>
