        ...
        <div data-role="page">
            ...
            <div data-role="panel" id="menuIzquierda" data-theme="b" data-display="reveal" data-dismissible="true">
                ...
                <div data-role="collapsible" data-theme="a">
                    ...
                    <ul data-role="listview">
                        ...
                        <li>
                            <a href="#" data-transition="slidedown" onclick="UtiProcesosPaginaProcesosVisitas()">Seguimientos</a>
                        </li>
            ...
            <div data-role="footer" data-theme="b" data-position="fixed">
                <div data-role="navbar">
                    <ul>
                        <li><a href="#" data-transition="flip" data-icon="plus" data-theme="b" onclick="UtiProcesosPaginaProcesosVisitasDetalle()">Agregar</a></li>
                    </ul>
                </div>
            </div>
        </div>
