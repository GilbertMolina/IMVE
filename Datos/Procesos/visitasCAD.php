...
if (isset($_POST['action']) && $_POST['action'] == 'registrarVisita') {
    try {
        ...
        if ($exito == "1"){
            ...
            $sqlSeguimiento1      = "CALL TbSeguimientosAgregar('$idVisita','1','Llamada #1','$fechaSeguimiento1','','$usuarioActual')";
            $consultaSeguimiento1 = $db->consulta(utf8_decode($sqlSeguimiento1));

            $sqlSeguimiento2      = "CALL TbSeguimientosAgregar('$idVisita','1','Llamada #2','$fechaSeguimiento2','','$usuarioActual')";
            $consultaSeguimiento2 = $db->consulta(utf8_decode($sqlSeguimiento2));

            $sqlSeguimiento3      = "CALL TbSeguimientosAgregar('$idVisita','2','Visita #1','$fechaSeguimiento3','','$usuarioActual')";
